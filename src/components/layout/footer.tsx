...
const socials: {
  ...
  { href: "https://x.com/randalfjs", icon: XIcon, label: "X" },
  {
      ...
      <Container>
        <div className="grid grid-cols-1 gap-8 py-12 md:grid-cols-3">
          <div className="space-y-3">
            <h3 className="text-lg font-medium">Randalf Ehigiator</h3>
        ...
        <div className="flex flex-col items-center justify-between border-t border-border/40 py-6 md:flex-row">
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} Randalf Ehigiator. All rights reserved.
          </p>
